...
type HexBinAccessor<T> = Accessor<
  { points: object[]; sumWeight: number; center: { lat: number; lng: number } },
  T
>;
...
export declare class ThreeGlobeGeneric<ChainableInstance> extends Object3D {
  ...
  arcColor(
    colorsAccessor: ObjAccessor<string | string[] | ((t: number) => string)>
  ): ChainableInstance;
  ...
  arcDashAnimateTime(
    durationMsAccessor: ObjAccessor<number>
  ): ChainableInstance;
  ...
  polygonGeoJsonGeometry(
    geometryAccessor: ObjAccessor<GeoJsonGeometry>
  ): ChainableInstance;
  ...
  polygonCapMaterial(
    materialAccessor: ObjAccessor<Material>
  ): ChainableInstance;
  ...
  polygonStrokeColor(
    colorAccessor: ObjAccessor<string | boolean | null>
  ): ChainableInstance;
  ...
  polygonCapCurvatureResolution(
    capCurvatureResolutionAccessor: ObjAccessor<number>
  ): ChainableInstance;
  ...
  heatmapColorFn(
    colorFnAccessor: ObjAccessor<(t: number) => string>
  ): ChainableInstance;
  heatmapColorSaturation(): ObjAccessor<number>;
  heatmapColorSaturation(
    saturationAccessor: ObjAccessor<number>
  ): ChainableInstance;
  ...
  hexPolygonResolution(
    resolutionAccessor: ObjAccessor<number>
  ): ChainableInstance;
  ...
  tileCurvatureResolution(
    curvatureResolutionAccessor: ObjAccessor<number>
  ): ChainableInstance;
  ...
  labelDotOrientation(
    orientationAccessor: ObjAccessor<LabelOrientation>
  ): ChainableInstance;
  ...
  ringColor(
    colorAccessor: ObjAccessor<string | string[] | ((t: number) => string)>
  ): ChainableInstance;
  ...
  htmlElement(
    htmlElementAccessor: HTMLElement | string | ((d: object) => HTMLElement)
  ): ChainableInstance;
  ...
  objectFacesSurface(
    facesSurfaceAccessor: ObjAccessor<boolean>
  ): ChainableInstance;
  objectThreeObject(): Object3D | string | ((d: object) => Object3D);
  objectThreeObject(
    object3DAccessor: Object3D | string | ((d: object) => Object3D)
  ): ChainableInstance;
  ...
  customThreeObjectUpdate():
    | string
    | ((obj: Object3D, objData: object) => void);
  customThreeObjectUpdate(
    object3dAccessor: string | ((obj: Object3D, objData: object) => void)
  ): ChainableInstance;
